...
Route::get('list/produk/masuk/Report', 'InfoinvenController@reportmasuk');
...
Route::get('list/produk/keluar/Report', 'InfoinvenController@reportkeluar');
...
Route::get('list/produk/pinjam/Report','InfoinvenController@reportpinjaman');
