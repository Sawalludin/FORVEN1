...
<html>
<head>
<title>REPORT DATA BARANG PEMINJAMAN</title>
<meta charset='utf-8'>
...
tr{background:#fff}
th{background:#1ebfae; color:#000; font-weight:400;}
...
<body>
    ...
    <h2 style="text-align:left;">Report Peminjaman</h2>
...
@else
    ...
    <td>{{ $pdf->info_produk}}</td>
    <td>{{ $pdf->nama_peminjam}}</td>
    <td>{{ $pdf->jumlah_pinjaman}}</td>
    <td>{{ $pdf->created_at}}</td>
    <td>{{ $pdf->tanggal_pengembalian}}</td>
...
@endif
    ...
    <tr>
    <td colspan="10">Report Peminjaman</td>
    </tr>
</table>
</body>
</html>